...
Tweeter.prototype.apiCall = function(method, path, opt, fn) {
    ...
    var req = { path: path + (query?'?'+query:''), method: method };
...
Tweeter.prototype.execute = function(path, options, cb) {
    ...
    req = client.request(options, function(res) {
        ...
        res.on('close', function() { req.emit('end'); });
    });    
...
Tweeter.prototype.get = function(path, options, cb) {
    ...
    this.execute(path, this.extend(options, { method: 'GET' }), cb );
    return this;
};
...
Tweeter.prototype.post = function(path, options, cb) {
    ...
    this.execute(path, this.extend(options, { method: 'POST' }), cb );
    return this;
};
...
Tweeter.prototype.oauthSignature = function(method, path, props, query) {
    var self = this;
    var composite = qs.escape(self.config.consumerSecret) + '&' + qs.escape(self.config.accessTokenSecret);
